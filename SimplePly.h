...
class SimplePly {
 public:
  ...
  // I added some extra things so that I can treat SimplePly like a std::vector
  void push_back(PlyPoint newPoint) { points_.push_back(newPoint); }
  PlyPoint back() { return points_.back(); }
